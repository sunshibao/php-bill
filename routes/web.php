...
Route::get('/wuge/submit', 'WugeController@submit');
Route::get('/newblog/category/{id}', 'NewBlogController@category')->name('newblog/category');
Route::get('/newblog/article/{id}', 'NewBlogController@article')->name('newblog/article');
Route::get('/newblog/about', 'NewBlogController@about');
Route::get('/newblog/tech-salon', 'NewBlogController@salon');
