...
(function (b, g) {
    function n(b) {
        return k ? k + b : b.toLowerCase()
    }

    var c = "", k, D = {Webkit: "webkit", Moz: "", O: "o"}, h = document.createElement("div"),
        E = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, t, u, v, w, x, y, z, A,
        d = {};
    h.style.transform === g && b.each(D, function (b, a) {
        if (h.style[b + "TransitionProperty"] !== g) return c = "-" + b.toLowerCase() + "-", k = a, !1
    });
    var B = c + "transform";
    ...
    b.fx = {
        off: k === g && h.style.transitionProperty === g,
        speeds: {_default: 400, fast: 200, slow: 600},
        cssPrefix: c,
        transitionEnd: n("TransitionEnd"),
        animationEnd: n("AnimationEnd")
    };
    b.fn.animate = function (c, a, d, l, e) {
        b.isFunction(a) && (l = a, a = d = g);
        b.isFunction(d) && (l = d, d = g);
        b.isPlainObject(a) && (d = a.easing, l = a.complete, e = a.delay, a = a.duration);
        a && (a = ("number" == typeof a ? a : b.fx.speeds[a] || b.fx.speeds._default) / 1E3);
        e && (e = parseFloat(e) / 1E3);
        return this.anim(c, a, d, l, e)
    };
    b.fn.anim = function (c, a, k, l, e) {
        var m, f = {}, h = "", n = this, q = b.fx.transitionEnd, C = !1;
        a === g && (a = b.fx.speeds._default / 1E3);
        e === g && (e = 0);
        b.fx.off && (a = 0);
        if ("string" == typeof c) f[x] = c, f[y] = a + "s", f[A] = e + "s", f[z] = k || "linear", q = b.fx.animationEnd; else {
            var r = [];
            for (m in c) E.test(m) ? h += m + "(" + c[m] + ") " : (f[m] = c[m], r.push(m.replace(/([A-Z])/g, "-$1").toLowerCase()));
            h && (f[B] = h, r.push(B));
            0 < a && "object" === typeof c && (f[t] = r.join(", "), f[u] = a + "s", f[w] = e + "s", f[v] = k || "linear")
        }
        var p = function (a) {
            if ("undefined" !== typeof a) {
                if (a.target !== a.currentTarget) return;
                b(a.target).unbind(q, p)
            } else b(this).unbind(q, p);
            C = !0;
            b(this).css(d);
            l && l.call(this)
        };
        0 < a && (this.bind(q, p), setTimeout(function () {
            C || p.call(n)
        }, 1E3 * (a + e) + 25));
...
(function (e) {
    ...
    function m(a, c) {
        ...
        if (b && b[2] in n) {
            ...
            var d = b[3];
            a = b[1];
            d && (b = Number(d), d = isNaN(b) ? d.replace(/^["']|["']$/g, "") : b)
        }
        return c(a, h, d)
    }

    var f = e.zepto, q = f.qsa, r = f.matches, n = e.expr[":"] = {
        visible: function () {
            ...
            if (-1 < e(this).text().indexOf(b)) return this
        }, has: function (a, c, b) {
            if (f.qsa(this, b).length) return this
        }
    }, p = /(.*):(\w+)(?:\(([^)]+)\))?$\s*/, t = /^\s*>/, k = "Zepto" + +new Date;
    f.qsa = function (a, c) {
        return m(c, function (b, h, d) {
            try {
                if (!b && h) b = "*"; else if (t.test(b)) {
                    var g = e(a).addClass(k);
                    b = "." + k + " " + b
                }
                var l = q(a, b)
            } catch (u) {
                throw console.error("error performing selector: %o", c), u;
            } finally {
                g && g.removeClass(k)
            }
            return h ? f.uniq(e.map(l, function (a, b) {
                return h.call(a, b, l, d)
            })) : l
        })
    };
    f.matches = function (a, c) {
        return m(c, function (b, c, d) {
            return (!b || r(a, b)) && (!c || c.call(a, null, d) === a)
        })
    }
})(Zepto);