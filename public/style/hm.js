(function () {
    var h = {}, mt = {}, c = {
        id: "7158c55a533ed0cf57dede022b1e6aed",
        dm: ["tech.meituan.com"],
        js: "tongji.baidu.com/hm-web/js.js/",
        etrk: [],
        cetrk: [],
        cptrk: [],
        icon: '',
    ...
    mt.cookie.hc = function (a, b) {
        try {
            ...
            mt.cookie.set(g, "is-cookie-enabled", {domain: a, path: b, Q: q});
            var d = "is-cookie-enabled" === mt.cookie.get(g) ? "1" : "0";
            mt.cookie.set(g, "", {domain: a, path: b, Q: -1});
            return d
        } catch (e) {
            return "0"
        }
    ...
    mt.lang.G = function (a, b) {
        ...
        if (Array.prototype.indexOf) g = -1 !== a.indexOf(b); else for (var d = 0; d < a.length; d++) if (a[d] === b) {
            g = u;
            break
        }
        return g
    ...
    (function () {
        ...
        mt.f.ua = function (a) {
            ...
            try {
                ...
                for (var d = a.split(">"), e = document.body, b = d.length - 1; 0 <= b; b--) if (-1 < d[b].indexOf("#")) {
                    var f = d[b].split("#")[1];
                ...
                for (a =
                    ...
                    if (!("html" === l || "body" === l)) {
                        var b = 0, n = d[a].match(/\[(\d+)\]/i), f = [];
                        if (n) b = n[1] - 1, l = l.split("[")[0]; else if (1 !== e.childNodes.length) {
        ...
        mt.f.getAttribute = function (a, d) {
            ...
            if (!e && a.attributes && a.attributes.length) for (var b = a.attributes, f = b.length, l = 0; l < f; l++) b[l].nodeName === d && (e = b[l].nodeValue);
            return e
        };
        mt.f.T = function (a) {
            var d = "document";
    ...
    mt.localStorage.remove = function (a) {
        if (window.localStorage) window.localStorage.removeItem(a); else if (mt.localStorage.ma()) try {
    ...
    mt.lb.log = function (a, b) {
        var g = new Image, d = "mini_tangram_log_" + Math.floor(2147483648 * Math.random()).toString(36);
        window[d] = g;
        g.onload = function () {
            g.onload = w;
            g = window[d] = w;
    ...
    (function () {
        var a = mt.cookie, b = mt.localStorage, g = mt.sessionStorage, d = {
            getData: function (d) {
                ...
                try {
                    a.set(e, r, {domain: d.R(), path: d.da(), Q: f}), f ? b.set(e, r, f) : g.set(e, r)
                } catch (l) {
                }
            }, removeData: function (e) {
                try {
                    a.set(e, "", {domain: d.R(), path: d.da(), Q: -1}), g.remove(e), b.remove(e)
                } catch (r) {
                }
            }, W: function (a, d) {
                a = "." + a.replace(/:\d+/, "");
                ...
                for (var a = document.location.hostname, b = 0, f = c.dm.length; b < f; b++) if (d.W(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[/?#].*/, "");
                return a
            }, da: function () {
    ...
    (function () {
        var a = mt.lang, b = mt.s, g = h.qa,
            ...
            r = ["session", "user"], f = "Hm_up_" + c.id, l = {
                init: function () {
                    l.ec()
                }, ec: function () {
                    try {
                    ...
                    if (a.d(t, "Object") && a.d(f, "Object")) {
                        for (var v in f) if (f.hasOwnProperty(v)) {
                            ...
                            if (g || !/^_/.test(k) && !/_$/.test(k) || /^(_iden|ei_|ec_|ex_|en_|et_|el_)$/.test(k)) {
                                var m = f[v];
                                if (m == w) delete t[k]; else {
                                    if (a.d(m, "Object") || a.d(m, "Array")) m = b.stringify(m);
                                    m = a.h(String(m));
                                    l.gc(e, k, m) && (t[k] = {value: m, scope: l.Wa(e)})
                                }
                            }
                        }
                        "user" === e && l.Ia()
                    ...
                    var f = u, g = d[a];
                    if (256 < encodeURIComponent(String(b)).length || 256 < encodeURIComponent(String(e)).length) f = x; else {
                        var k = g[b];
                        g[b] = {value: e, scope: l.Wa(a)};
                        a = l.O(l.A(a));
    ...
    (function () {
        var a = mt.f, b = mt.lang, g = h.z, d = h.ra, e = h.P, r = e.O;
        if (b.isArray(c.cptrk) && 0 < c.cptrk.length) {
            var f = {
                cb: {}, ka: {}, init: function () {
                    for (var a, e = d.ca(c.cptrk) || [], g = 0; g < e.length; g++) if (a = e[g], a.a !== q && b.d(a.a, "Object")) {
                        a = a.a;
                        for (var s in a) a.hasOwnProperty(s) && (f.ka[s] = String(a[s]))
                    }
                }, bb: function () {
                    var b, d, e;
                    for (e in f.ka) if (f.ka.hasOwnProperty(e) && f.cb[e] === q && (b = f.ka[e], b = a.ua(b))) d = d === q ? {} : d, d[e] = a.S(b, x), f.cb[e] = u;
                    return d
                }, Aa: function () {
                    var a = f.bb();
                    a && f.nc(a)
        ...
        var a = mt.lang, b = mt.f, g = h.ra, d = {
            ba: function (a, r) {
                return function (f) {
                    ...
                    if (l) {
                        var n = g.ca(r) || [], p = l.getAttribute(a.la);
                        f = f.clientX + ":" + f.clientY;
                        if (p && p === f) l.removeAttribute(a.la); else if (0 < n.length && (l = b.Qb(l)) && l.length) if (n = l.length, p = l[l.length - 1], 1E4 > n * p.split(">").length) for (p = 0; p < n; p++) d.jb(a, l[p]); else d.jb(a, p)
                    }
                }
            }, jb: function (b, d) {
        ...
        var a = mt.f, b = mt.event, g = mt.lang, d = h.D, e = h.ra, r = h.ta, f = h.P, l = f.O, n = {
            la: "HM_ce", pb: function () {
                ...
                if (0 < a.indexOf("*")) {
                    ...
                    for (e in b) if (b.hasOwnProperty(e) && d.test(e)) return e;
                    return w
                }
                return b.hasOwnProperty(a) ? a : w
            }, w: function (b, d) {
                h.c.b.et = 7;
                var e = b && b.k || "", e = g.h(e), v = {};
                if (b && b.a && g.d(b.a, "Object")) {
                    var k = b.a, m;
                    for (m in k) if (k.hasOwnProperty(m)) {
                        var y = n.Rb(k[m] || "", d), y = y ? a.S(y, x) : "";
                        v[m] = y
                    }
                }
                v = n.Gb(v, d || b && b.p);
    ...
    (function () {
        var a = mt.lang, b = mt.f, g = mt.event, d = mt.g, e = h.D, r = h.z, f = h.P, l = f.O, n = +new Date, p = [],
            s = {
                ba: function () {
                    return function (d) {
                        if (h.c && h.c.V && c.aet && c.aet.length) {
                            ...
                            if (f) {
                                var g = h.c.Ra, m = b.getAttribute(f, e.Qa) != w ? u : x;
                                if (b.getAttribute(f, e.Pa) == w) if (m) s.na(s.va(f, d)); else {
                                    var y = b.T(f);
                                    if (a.G(g, "*") || a.G(g, y)) s.na(s.va(f, d)); else for (; f.parentNode != w;) {
                                        var m = f.parentNode, y = b.T(m), z = "a" === y && a.G(g, "a") ? u : x,
                    ...
                    b = [+new Date - (h.c.X !== q ? h.c.X : n), d(b.id), d(b.aa), d(b.ia),
                        d(b.$), d(b.link), d(b.content), b.type, b.uc, b.Fa, b.Ha, b.Na, b.za, b.La].join("*");
                    s.oa(b);
    ...
    (function () {
        var a = mt.lang, b = mt.event, g = mt.g, d = h.D, e = h.z, r = +new Date, f = [], l = w, n = {
            tb: function () {
    ...
    (function () {
        ...
        function b() {
            ...
            if ((!f || !n) && l && p) k = u, t = +new Date; else if (f && n && (!l || !p)) k = x, v += +new Date - t;
            f = l;
            n = p;
            z = setTimeout(b, 100)
        }
        ...
        function g(a) {
            var m = document, b = "";
            if (a in m) b = a; else for (var d = ["webkit", "ms", "moz", "o"], f = 0; f < d.length; f++) {
        ...
        var e = mt.event, r = h.z, f = u, l = u, n = u, p = u, s = +new Date, t = s, v = 0, k = u,
            m = g("visibilityState"), y = g("hidden"), z;
        b();
        (function () {
    ...
    (function () {
        var a = mt.lang, b = h.D, g = h.load, d = {
            bc: function (d) {
                if ((window._dxt === q || a.d(window._dxt, "Array")) && "undefined" !== typeof h.c) {
                    var r = h.c.R();
                    g([b.protocol, "//datax.baidu.com/x.js.js?si=", c.id, "&dm=", encodeURIComponent(r)].join(""), d)
                }
            }, tc: function (b) {
    ...
    (function () {
        function a(a, b, d, f) {
            if (!(a === q || b === q || f === q)) {
                ...
                a = String(a).split("!");
                for (var e, g = x, k = 0; k < a.length; k++) if (e = a[k].split("*"), String(b) === e[0]) {
                    e[1] = d;
                    e[2] = f;
                    a[k] = e.join("*");
                    g = u;
        ...
        var g = mt.url, d = mt.lang, e = mt.s, r = mt.g, f = h.D, l = h.z, n = h.zb, p = h.load, s = h.qa, t = h.P,
            v = t.O, k = {
                Y: [], ha: 0, Da: x,
                C: {Ma: "", page: ""}, init: function () {
                    ...
                    var a = window._hmt;
                    if (a && a.cmd && a.cmd[c.id]) for (var b = a.cmd[c.id], d = /^_track(Event|MobConv|Order)$/, f = 0, e = b.length; f < e; f++) {
                        var g = b[f];
                        d.test(g[0]) ? k.Y.push(g) : k.Ja(g)
                    }
                    a.cmd[c.id] = {push: k.Ja}
                }, Db: function () {
                    if (0 < k.Y.length) for (var a = 0, b = k.Y.length; a < b; a++) k.Ja(k.Y[a]);
                    k.Y = w
                }, Ja: function (a) {
                    var b =
                        a[0];
                    ...
                    if (!(3 > b.length)) {
                        ...
                        b = d.h(b[2]);
                        if (f !== q && b !== q) {
                            var e = decodeURIComponent(s.getData("Hm_ct_" + c.id) || ""), e = a(e, f, 1, b);
                    ...
                    if (1 < a.length) {
                        ...
                        if (d.G(f.eb,
                            ...
                            var l = a[g][2] || {};
                            if (b.plugins[e] && !b.I[e]) b.I[e] = new b.plugins[e](l), b.B.shift(); else break
                        }
                    }
                }, _requirePlugin: function (a) {
                    if (1 < a.length) {
                        var b = window._hmt, e = a[1], g = a[2] || {};
                        if (d.G(f.eb, e)) if (b.plugins = b.plugins || {}, b.I = b.I || {}, b.plugins[e] && !b.I[e]) b.I[e] = new b.plugins[e](g); else {
                            b.B = b.B || [];
                            for (var g = 0, l = b.B.length; g < l; g++) if (b.B[g][1] ===
                                e) return;
                            b.B.push(a);
                            k._require([w, f.ic + e + ".js.js"])
                        }
                    }
    ...
    (function () {
        ...
        var b = mt.url, g = mt.lb, d = mt.Ka, e = mt.lang, r = mt.cookie, f = mt.g, l = mt.sessionStorage, n = mt.s,
            p = mt.event, s = h.qa, t = h.P, v = t.O, k = h.D, m = h.load, y = h.z;
        a.prototype = {
            W: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                for (var a = document.location.hostname, b = 0, d = c.dm.length; b < d; b++) if (this.W(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[/?#].*/, "");
                return a
            }, da: function () {
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var d = c.dm[a];
                ...
                var a = document.location.hash.substring(1),
                    d = RegExp(c.id), e = b.L(document.referrer) === k.nb ? 1 : 0, f = b.m(a, "jn"),
                    g = /^select$/.test(f);
                a && (d.test(a) && e && g) && (this.b.rnd = Math.round(Math.random() * k.Ga), a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", k.protocol + "//" + c.js + f + ".js.js?" + this.b.rnd), f = document.getElementsByTagName("script")[0], f.parentNode.insertBefore(a, f))
            }, xb: function () {
                try {
                        ...
                        p.e(window, "message",
                            function (d) {
                                if (b.L(d.origin) === k.nb) {
                                    ...
                                    if (RegExp(c.id).test(d.sd || "") && f) a.b.rnd = Math.round(Math.random() * k.Ga), m(k.protocol + "//" + c.js + e + ".js.js?" + a.b.rnd)
                                }
                            });
    ...
    (function () {
        var a = mt.g, b = mt.lang, g = mt.event, d = mt.s;
        if ("undefined" !== typeof h.c && (c.med || (!a.Ca || 7 < a.Nb()) && c.cvcc)) {
            var e, r, f, l, n = function (a) {
                ...
                k.v = a;
                if (g) {
                    var l = g.getAttribute("href"), n = g.getAttribute("onclick") ? "" + g.getAttribute("onclick") : w,
                        p = g.getAttribute("id") || "";
                    f.test(l) ? (k.sn =
            ...
            if ("undefined" !== typeof l && "undefined" !== typeof f) {
                ...
                var k = function (a, d) {
                    ...
                    if (b.d(d, "Array") || b.d(d, "NodeList")) for (var e = 0, f = d.length; e < f; e++) if (v === d[e]) return s(r + a + "/" + (e + 1), d[e]), x
                };
    ...
    (function () {
        var a = mt.f, b = mt.lang, g = mt.event, d = mt.s;
    ...
    (function () {
        ...
        if (c.med && "undefined" !== typeof h.c) {
            var g = {n: "anti", sb: 0, kb: 0, clk: 0}, d = function () {
                h.c.b.et = 86;
